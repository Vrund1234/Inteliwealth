...
# Rules whose answer is an assertion of fact rather than a score. They displace
# an equal-confidence incumbent instead of deferring to it, because the rules
# they have to beat — ISIN_MATCH and PRODUCT_MATCH — also sit at 100 and run
# first. Deferring would make a curator's correction a no-op.
AUTHORITATIVE_RULES = frozenset({"OVERRIDE"})
