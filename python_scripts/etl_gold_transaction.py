...
# =====================================================
# FAST TRANSACTION CLASSIFICATION
# =====================================================
...
def transform_transactions(df):
    ...
    print(
        ...
        master_scheme["scheme_code"].nunique()
    )
